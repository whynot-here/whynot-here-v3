<template>
  <div v-if="isShow" class="popup-wrap">
    <div v-if="type == 1" class="popup">
      ...
      <p>
        &lt;Why Not Here 운영팀>('https://why-not-here.o-r.kr'이하 'Why Not
        Here')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를
        보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기
        위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
      </p>
      <p>○ 이 개인정보처리방침은 2023 년 1월13부터 적용됩니다.</p>

      <p>
        제1조(개인정보의 처리 목적)&lt; Why Not Here
        운영팀>('https://why-not-here.o-r.kr'이하 'Why Not Here') 은(는) 다음의
      ...
      <p>
        제2조(개인정보의 처리 및 보유 기간)① &lt; Why Not Here 운영팀> 은(는)
      ...
      <p>- 보유근거 : 한동대학교 학생 플랫폼</p>
      <p>- 관련법령 : 신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년</p>
      <p>
        - 예외사유 : 명시적 회원 탈퇴가 아닌 경우 예외적 상황을 대비하여 보관
      </p>

      <p>
        제3조(처리하는 개인정보의 항목)① &lt; Why Not Here 운영팀> 은(는) 다음의
        개인정보 항목을 처리하고 있습니다.
      </p>

      <p>- 1&lt; 홈페이지 회원가입 및 관리></p>
      <p>- 필수항목 : 이메일, 로그인ID, 서비스 이용 기록</p>
      <p>- 선택항목 : 이메일</p>

      <p>
        제4조(개인정보의 제3자 제공에 관한 사항)① &lt; Why Not Here
        운영팀>은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위
      ...
      <p>
        ② &lt; Why Not Here 운영팀> 은(는) 다음과 같이 개인정보를 제3자에게
        제공하고 있습니다.
      </p>
      <p>• 1. &lt; Why Not Here 운영팀></p>
      <p>• 개인정보를 제공받는 자 : Why Not Here 운영팀</p>
      <p>
        • 제공받는 자의 개인정보 이용목적 : 이메일, 로그인ID, 서비스 이용 기록
      </p>
      <p>• 제공받는 자의 보유.이용기간: 5년</p>
      <p>
        제5조(개인정보처리의 위탁에 관한 사항)① &lt; Why Not Here 운영팀> 은(는)
        원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를
        위탁하고 있습니다.
      </p>
      <p>• 1. &lt; Why Not Here 운영팀></p>
      <p>• 위탁받는 자 (수탁자) : Why Not Here 운영팀</p>
      <p>• 위탁하는 업무의 내용 : 불만처리 등 민원처리</p>
      <p>• 위탁기간 : 3년</p>
      <p>
        ② &lt; Why Not Here 운영팀> 은(는) 위탁계약 체결시 「개인정보 보호법」
      ...
      <p>
        제6조(개인정보의 파기절차 및 파기방법)① &lt; Why Not Here 운영팀> 은(는)
        ...
        별도의 데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.1.
        법령 근거 :2. 보존하는 개인정보 항목 : 계좌정보, 거래날짜③ 개인정보
        파기의 절차 및 방법은 다음과 같습니다.1. 파기절차 &lt; Why Not Here
        운영팀> 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt; Why Not Here
        운영팀> 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
      </p>
      <p>2. 파기방법</p>
      <p>
      ...
      <p>
        ① 정보주체는 Why Not Here 운영팀에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
      </p>
      <p>
        ② 제1항에 따른 권리 행사는Why Not Here 운영팀에 대해 「개인정보 보호법」
        시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실
        수 있으며 Why Not Here 운영팀은(는) 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p>
      ...
      <p>
        ⑥ Why Not Here 운영팀은(는) 정보주체 권리에 따른 열람의 요구,
        정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나
        정당한 대리인인지를 확인합니다.
      </p>
      <p>
        제8조(개인정보의 안전성 확보조치에 관한 사항) &lt; Why Not Here 운영팀>
        은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
      </p>
      <p>
        1. 비인가자에 대한 출입 통제개인정보를 보관하고 있는 물리적 보관 장소를
      ...
      <p>
        ① Why Not Here 운영팀 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
      ...
      <p>
        ② &lt;개인정보처리자>은(는) 다음과 같이 행태정보를 수집합니다.10.
        행태정보의 수집·이용·제공 및 거부 등에 관한 사항 제공을 위해 수집하는
        행태정보의 항목, 행태정보 수집 방법, 행태정보 수집 목적, 보유·이용기간
        및 이후 정보처리 방법을 입력하기 위한 표입니다.수집하는 행태정보의
        항목행태정보 수집 방법행태정보 수집 목적보유·이용기간 및 이후 정보처리
        방법이용자의 서비스 활동 이력앱 서버 로그이용자 고객문의
        대응수집일로부터 30일 후 파기
      </p>
      <p>
      ...
      <p>
        ...
        행태정보를 수집·처리하도록 허용하고 있습니다.
      </p>
      <p>- 행태정보를 수집 및 처리하려는 광고 사업자 : ○○○, ○○○, ○○○, ○○○,</p>
      <p>
      ...
      <p>
        ...
        미만의 아동을 주 이용자로 하는 온라인 서비스로부터 맞춤형 광고 목적의
      ...
      <p>‣ 개인정보 보호 담당부서</p>
      <p>부서명 : Why Not Here 운영팀</p>
      <p>담당자 : 오상진</p>
      <p>연락처 : 010-3093-3474, handong3474@gmail.com</p>
      <p>
        제11조(추가적인 이용·제공 판단기준) &lt; Why Not Here 운영팀> 은(는)
        ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보 보호법
        시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를
        추가적으로 이용·제공할 수 있습니다.이에 따라 &lt; Why Not Here 운영팀>
        가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은
        사항을 고려하였습니다.▶ 개인정보를 추가적으로 이용·제공하려는 목적이
        당초 수집 목적과 관련성이 있는지 여부
      </p>

      <p>제13조 (개인정보 보호책임자에 관한 사항)</p>
      <p>
        ① Why Not Here 운영팀 은(는) 개인정보 처리에 관한 업무를 총괄해서
      ...
      <p>• 연락처 :010-3093-3474, handong3474@gmail.com,</p>
      <p>
        ② 정보주체께서는 Why Not Here 운영팀 의 서비스(또는 사업)을 이용하시면서
        발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. Why Not Here
        운영팀 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
        것입니다.
      </p>
      <p>
        제14조(개인정보의 열람청구를 접수·처리하는 부서)정보주체는 ｢개인정보
        보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수
        있습니다.&lt; Why Not Here 운영팀>은(는) 정보주체의 개인정보 열람청구가
        신속하게 처리되도록 노력하겠습니다.
      </p>
      ...
      <p>• 연락처 : 010-3093-3474, handong3474@gmail.com,</p>
      <p>
        제15조(정보주체의 권익침해에 대한 구제방법)정보주체는 개인정보침해로
      ...
      <p>① 이 개인정보처리방침은 2023년 1월 13부터 적용됩니다.</p>
    </div>
  </div>
</template>
